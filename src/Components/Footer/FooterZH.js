    ...
    return (
      <footer>
        <div className="copyright">
          ...
          <div className="footer_column">
            <p> 版权 &copy; {this.state.date} | <a href="http://www.bu.edu/cgcm/" target="_blank">Center for Global Christianity and Mission</a>, <a href="http://www.bu.edu/" target="_blank">Boston University</a>.</p>
          </div>
        </div>
      </footer>
    );
